...
class Pedido(models.Model): 
    ...
    pagamento_opcoes = [
        (pagamento_a_vista , 'Pagamento á vista'),
        (pagamento_2x, 'Pagamento em 2 vezes'),
        (pagamento_3x, 'Pagamento em 3 vezes'),
        (pagamento_4x, 'Pagamento em 4 vezes'),
        (pagamento_5x, 'Pagamento em 5 vezes'),
    ]
